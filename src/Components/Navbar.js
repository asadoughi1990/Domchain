      ...
      <React.Fragment>
        <nav className="navbar navbar-expand-lg custom-toggler fixed-top navbar-site">
          <div className="container">
            <AnchorLink id="homelink" className="navbar-brand" href="#intro">
            ...
            >
              <ul id="navbar-items-custom" className="navbar-nav ml-auto">
                <li className="nav-item active">
                  <AnchorLink id="homelink" className="nav-link" href="#intro">
                    Home
                  </AnchorLink>
                </li>
              ...
              <button className="btn btn-custom-iot my-2 my-sm-0 px-4">
                Start Trading
              </button>
            </div>
          </div>
